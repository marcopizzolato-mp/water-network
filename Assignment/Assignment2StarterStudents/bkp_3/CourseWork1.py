...
def calculateFlowsAndPlot(elevation, rain, resampleF):
  ...
  #  plotFlowNetwork(elevation, fr, "test marco", plotLakes=False)
    ############# step 4 and step 5 #######################################
    # handle lakes
    fr.calculateLakes(rain)
  #  print(fr.printFlow())
...
rainrasterA=createRanRasterSlope(rows//resampleFactorA,cols//resampleFactorA,cellsize*resampleFactorA,xorg,yorg,nodata,levels,40,1,36,4,.1)   
# calculate the 
