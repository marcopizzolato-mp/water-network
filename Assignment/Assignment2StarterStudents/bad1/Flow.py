...
#return x,y tupel        
    ...
    def setLakeID2(self, value):
        self._lakeID2 = value
        
    def getLakeID2(self):
        return self._lakeID2
...
class FlowRaster(Raster):
    ...
    def lowestNeighbour(self,r,c):
        ...
        for neighbour in self.getNeighbours(r,c):
            ...
            #and if not neighbour in mylake
    
            
                #if ( (lownode==None or neighbour.getElevation() < lownode.getElevation()) and neighbour.getLakeFlag() == False and neighbour.getLakeID2() != self.getLakeID2() ):
                #if ( (lownode==None or neighbour.getElevation() < lownode.getElevation()) and (neighbour.getLakeFlag() == False and neighbour.getLakeID2() =! self.getLakeID2()) ):
...
#                    print (aaa.getElevation())
                ...
                #self._lakeListino.append(mylake) #this is a list of lakes, not a list of nodes
                #lakeIndex +=1
                #mylake._lakeID=lakeIndex
                #print (self._lakeListino)
