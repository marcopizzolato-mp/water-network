...
### TASK WEEK 2 ###
    def distancePointToLine(self,polyline):
        # Receives a polyline object - list of points 2D
        # get the min and the max - create a segment between them
        # calculate the distance point to segment
        
        listLen = len(segment)
        start_point = segment[0]
        end_point = segment[listLen]
...
# sub class of point 2D extensiomn of points 2D
